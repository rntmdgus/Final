var bg, bg2, wheel1, wheel2, castel1, castel2, castel3, castel4, castel5, humen, flag, countcastel;
...
function draw(){
   ...
   //사람
      image(humen,1450+sin(t1*2*PI+2*PI/4*i)*250-50,900+cos(t1*2*PI+2*PI/4*i)*50-50,100,100);
